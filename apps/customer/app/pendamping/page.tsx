// apps/customer/app/pendamping/page.tsx — kelola berbagi ke pendamping/keluarga.
import React from 'react';
import Link from 'next/link';
import { getCustomerAuth } from '../../lib/auth';
import { linksAsPatient, linksAsCaregiver } from '../../lib/data';
...
export default async function PendampingPage() {
  ...
  const [asPatient, asCaregiver] = await Promise.all([linksAsPatient(), linksAsCaregiver()]);
  ...
  return (
    <div className="screen">
      ...
      <CaregiverManager asPatient={asPatient} asCaregiver={asCaregiver} />
