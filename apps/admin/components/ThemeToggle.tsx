'use client';
// apps/admin/components/ThemeToggle.tsx — ganti tema terang/gelap (persist).
  ...
  return (
    <button
      ...
      style={{
        ...
        margin: '0 10px 8px', padding: '9px 12px', borderRadius: 10, cursor: 'pointer',
        font: 'inherit', fontSize: 13, color: 'var(--rail-text)',
